...
export const siteConfig = {
  ...
  title: 'Freelance Mobile and Website developer for Hire',
  description:
    'Hillary Nyakundi — Mobile and Website developer turning ideas into fast, scalable mobile and website apps. Based in Kenya, available for freelance and full-time work.',
  url: (
